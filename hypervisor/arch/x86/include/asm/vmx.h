...
#define EPT_FLAG_SUPERVISOR_EXECUTE   	(0x1UL << 2)
#define EPT_FLAG_USER_EXECUTE         	(0x1UL << 10)
#define EPT_FLAG_EXECUTE               	(EPT_FLAG_USER_EXECUTE | EPT_FLAG_SUPERVISOR_EXECUTE) 
